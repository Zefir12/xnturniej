...
export const playerMappings = {
    ...
    [PlayerAccounts.RandomBruces]: { name: 'RandomBruce', avatar: randombruce },
    [PlayerAccounts.Diables]: { name: 'Diables', avatar: diables },
    [PlayerAccounts.Netrodal]: { name: 'Netrodal', avatar: netrodal },
    [PlayerAccounts.Bagieta]: { name: 'Bagieta', avatar: bagieta },
    [PlayerAccounts.Suchar]: { name: 'MokrySuchar', avatar: suchar },
    [PlayerAccounts.Overpow]: { name: 'Overpow', avatar: overpow },
    [PlayerAccounts.Kubon]: { name: 'Kubon', avatar: kubon },
    [PlayerAccounts.Demonz]: { name: 'Demonz', avatar: demonz },
}
